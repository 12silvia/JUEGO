...
print("""1)Preguntas aleatrorias de Cálculo álgebra Física  proramación \n
...
class palabra():
    global pt
    palabras = "c2", "c518", "crango", "avariable", "a3x-3xy+6", "a2500", "fenergia", "felectricidad", "fjoule", "ppseudocodio", "pcodificacion ".split()
